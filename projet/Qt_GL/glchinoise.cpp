...
//=========================================================================================================
//=========================================================================================================
void GLSphereCoupe::initialize(GLuint slices, GLuint stacks)
{
  ...
  positions << 0.0 << 0.0 << cos(20*alpha);   //point max en x,y,z
  ...
  positions << 0.0 << 0.0 << -1.0;      //point min en x,y,z
...
//=========================================================================================================
void GLSphereCoupe::draw(QOpenGLShaderProgram& program, int attributeLocation)
{
  bind();
...
//=========================================================================================================
void GLSphereCoupe::bind()
{
  vbo.bind();
  ibo.bind();
}
//=========================================================================================================
void GLSphereCoupe::release()
{
  ibo.release();
  vbo.release();
}
